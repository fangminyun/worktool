...
public class GenUtils {
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        for (Map<String, String> column : columns) {
            ...
            Object length = column.get("length") == null ? "0" : column.get("length");
            columnEntity.setLength(length.toString());
            columnEntity.setFlagNull(column.get("isNull"));
...
//                if (!template.equals("template/menu.sql.vm") && !template.equals("template/index.vue.vm") &&
//                        !template.equals("template/add-or-update.vue.vm") && !template.equals("template/MongoEntity.java.vm")) {
                    generateToFile(sw.toString(), getConfig().getString("genpackage") + File.separator + fileName);
//                } else {
                //添加到zip
...
//                }
     ...
     * @return
     */
    public static void generateToFile(String content, String fileName) {
        // 创建并写入文件
    ...
    public static String getFileName(String template, String className, String packageName, String moduleName) {
        ...
        if (template.contains("index.vue.vm")) {
            return "views" + File.separator + moduleName + File.separator + className.toLowerCase() + ".vue";
        }

        if (template.contains("add-or-update.vue.vm")) {
            return "views" + File.separator + moduleName + File.separator + className.toLowerCase() + "-add-or-update.vue";
        }
